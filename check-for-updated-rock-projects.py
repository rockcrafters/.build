...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scan the ubuntu-rocks GitHub organization, finding which ROCK repos have been updated and need a new build."
    )
    parser.add_argument(
        "--token",
        dest="token",
    ...
    if args.on_repo:
        logging.info(
            f"Check for updates only on repo {args.on_repo}"
        )
        exclude_repos = []
